...
namespace QifApi.Logic
{
    internal static class CreditCardLogic
    {
        ...
        internal static List<BasicTransaction> Import(string transactionItems, Configuration config, AccountListTransaction lastImportedAccountReference)
        {
            List<BasicTransaction> result = new List<BasicTransaction>();

            // Create a new bank transaction
            BasicTransaction cct = lastImportedAccountReference.BuildBasicTransaction();
                ...
                if (sEntry.Length > 0)
                {
                    ...
                    switch (sEntry[0].ToString())
                    {
                        ...
                        case NonInvestmentAccountFields.EndOfEntry:
                            ...
                            // Create a new bank transaction
                            cct = lastImportedAccountReference.BuildBasicTransaction();
